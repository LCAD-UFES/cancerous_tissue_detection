...
def main():
    ...
    RUNS_FOLDER = '/home/ghendrix/calc_cancer_detector/src/squeezeNet/runs_manual_cropped_dataset'
    ...
    if arguments.initModel is not None:
        INITIAL_MODEL = str(arguments.initModel) # '/home/ghendrix/breast_cancer_analyzer_LCAD/src/squeezeNet/runs_manual_cropped_dataset/squeezenet1_1/31/models/squeezenet1_1_50_1.pth'
    INITIAL_MODEL_TEST = False

    TRAINING = (
        str(arguments.root) + '/calc_cancer_detector/src/squeezeNet/aux_files/training_dataset_ijcnn.txt',
    # 57344 imagens
    )

    TRAINING_DIR = (
        str(arguments.root) + '/calc_cancer_detector/dataset/cancer_tissue_dataset/manual_cropped_dataset',
    )
    ...
    TEST = (
        # str(arguments.root) + '/calc_cancer_detector/src/squeezeNet/aux_files/cbisddsm_val_2019_09_12_1.txt', #832 imagens
        str(arguments.root) + '/calc_cancer_detector/src/squeezeNet/aux_files/cbisddsm_val_2019_10_15.txt',  # 7168 imagens
    )
